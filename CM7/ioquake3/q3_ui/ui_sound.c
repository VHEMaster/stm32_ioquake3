...
/*
=================
Q3UI_SoundOptionsMenu_Event
=================
*/
static void Q3UI_SoundOptionsMenu_Event( void* ptr, int event ) {
	...
	case ID_EFFECTSVOLUME:
		UI_trap_Cvar_SetValue( "s_volume", soundOptionsInfo.sfxvolume.curvalue / 10 );
		break;

	case ID_MUSICVOLUME:
		UI_trap_Cvar_SetValue( "s_musicvolume", soundOptionsInfo.musicvolume.curvalue / 10 );
		break;

	case ID_QUALITY:
		if( soundOptionsInfo.quality.curvalue ) {
			UI_trap_Cvar_SetValue( "s_khz", 22 );
			UI_trap_Cvar_SetValue( "s_compression", 0 );
		}
		else {
			UI_trap_Cvar_SetValue( "s_khz", 11 );
			UI_trap_Cvar_SetValue( "s_compression", 1 );
		}
		Q3UI_ForceMenuOff();
		UI_trap_Cmd_ExecuteText( EXEC_APPEND, "snd_restart\n" );
		break;
/*
	case ID_A3D:
		if( soundOptionsInfo.a3d.curvalue ) {
			UI_trap_Cmd_ExecuteText( EXEC_NOW, "s_enable_a3d\n" );
		}
		else {
			UI_trap_Cmd_ExecuteText( EXEC_NOW, "s_disable_a3d\n" );
		}
		soundOptionsInfo.a3d.curvalue = (int)UI_trap_Cvar_VariableValue( "s_usingA3D" );
		break;
*/
	case ID_BACK:
		Q3UI_PopMenu();
...
/*
===============
Q3UI_SoundOptionsMenu_Init
===============
*/
static void Q3UI_SoundOptionsMenu_Init( void ) {
	int				y;
	...
	soundOptionsInfo.graphics.generic.callback	= Q3UI_SoundOptionsMenu_Event;
	...
	soundOptionsInfo.display.generic.callback	= Q3UI_SoundOptionsMenu_Event;
	...
	soundOptionsInfo.sound.generic.callback		= Q3UI_SoundOptionsMenu_Event;
	...
	soundOptionsInfo.network.generic.callback	= Q3UI_SoundOptionsMenu_Event;
	...
	soundOptionsInfo.sfxvolume.generic.callback	= Q3UI_SoundOptionsMenu_Event;
	...
	soundOptionsInfo.musicvolume.generic.callback	= Q3UI_SoundOptionsMenu_Event;
	...
	soundOptionsInfo.quality.generic.callback	= Q3UI_SoundOptionsMenu_Event;
...
/*
	...
	soundOptionsInfo.a3d.generic.callback		= Q3UI_SoundOptionsMenu_Event;
...
*/
	...
	soundOptionsInfo.back.generic.callback		= Q3UI_SoundOptionsMenu_Event;
...
//	Menu_AddItem( &soundOptionsInfo.menu, ( void * ) &soundOptionsInfo.a3d );
	...
	soundOptionsInfo.sfxvolume.curvalue = UI_trap_Cvar_VariableValue( "s_volume" ) * 10;
	soundOptionsInfo.musicvolume.curvalue = UI_trap_Cvar_VariableValue( "s_musicvolume" ) * 10;
	soundOptionsInfo.quality.curvalue = !UI_trap_Cvar_VariableValue( "s_compression" );
//	soundOptionsInfo.a3d.curvalue = (int)UI_trap_Cvar_VariableValue( "s_usingA3D" );
}
...
void Q3UI_SoundOptionsMenu( void ) {
	Q3UI_SoundOptionsMenu_Init();
	Q3UI_PushMenu( &soundOptionsInfo.menu );
