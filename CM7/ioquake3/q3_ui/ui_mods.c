...
===============
*/
static void Q3UI_Mods_MenuEvent( void *ptr, int event ) {
	...
	case ID_GO:
		UI_trap_Cvar_Set( "fs_game", s_mods.fs_gameList[s_mods.list.curvalue] );
...
/*
===============
Q3UI_Mods_ParseInfos
===============
*/
static void Q3UI_Mods_ParseInfos( char *modDir, char *modDesc ) {
...
===============
*/
static void Q3UI_Mods_LoadMods( void ) {
	int		numdirs;
	char	dirlist[2048];
	char	*dirptr;
  char  *descptr;
    ...
    descptr = dirptr + dirlen;
  	Q3UI_Mods_ParseInfos( dirptr, descptr);
...
===============
*/
static void Q3UI_Mods_MenuInit( void ) {
	Q3UI_ModsMenu_Cache();
	...
	s_mods.back.generic.callback	= Q3UI_Mods_MenuEvent;
	...
	s_mods.go.generic.callback		= Q3UI_Mods_MenuEvent;
	...
	s_mods.list.generic.callback	= Q3UI_Mods_MenuEvent;
...
===============
*/
void Q3UI_ModsMenu( void ) {
	Q3UI_Mods_MenuInit();
	Q3UI_PushMenu( &s_mods.menu );
}
