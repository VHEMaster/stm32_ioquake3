...
void UpdateTournamentInfo( void ) {
  ...
  int score1, score2;
	...
	G_trap_SendConsoleCommand( EXEC_APPEND, msg );
}
...
static void PodiumPlacementThink( gentity_t *podium ) {
	...
	VectorMA( level.intermission_origin, G_trap_Cvar_VariableIntegerValue( "g_podiumDist" ), vec, origin );
	origin[2] -= G_trap_Cvar_VariableIntegerValue( "g_podiumDrop" );
