        ...
        void calculateLighting(TriangleList &triangles) {
            ...
            for (auto &t : triangles) {
                ...
                for (auto &v : t.v) {
                    ...
                    v.colorPrimary.a() = CLAMP(m_material[0].diffuseColor.a(), 0.0f, 1.0f);
                    v.colorPrimary.b() = CLAMP(resultB, 0.0f, 1.0f);
                    v.colorPrimary.g() = CLAMP(resultG, 0.0f, 1.0f);
                    v.colorPrimary.r() = CLAMP(resultR, 0.0f, 1.0f);
