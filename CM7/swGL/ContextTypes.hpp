...
namespace SWGL {
    ...
    public:
        ...
        void setAlphaFunc(GLenum testFunc, GLclampf refValue) {
            ...
            m_testFunc = testFunc;
            m_refValue = CLAMP(refValue, 0.0f, 1.0f);
        }
    ...
    public:
        void setClearColor(float red, float green, float blue, float alpha) {
            ...
            m_colorRed = CLAMP(red, 0.0f, 1.0f);
            m_colorGreen = CLAMP(green, 0.0f, 1.0f);
            m_colorBlue = CLAMP(blue, 0.0f, 1.0f);
            m_colorAlpha = CLAMP(alpha, 0.0f, 1.0f);
        ...
        void setClearDepth(double depth) {
            ...
            auto depthValue = CLAMP(static_cast<float>(depth), 0.0f, 1.0f);
    ...
    public:
        void setDimensions(int x, int y, int width, int height) {
            ...
            m_width = CLAMP(width, 0, 2048);
            m_height = CLAMP(height, 0, 2048);
            m_x = x;
            m_y = y;
        ...
        void setDepthRange(double zNear, double zFar) {
            ...
            float n = CLAMP(static_cast<float>(zNear), 0.0f, 1.0f);
            float f = CLAMP(static_cast<float>(zFar), 0.0f, 1.0f);
